                        ...
                        event.stopPropagation();
                         // Guardo el nombre del menu
                                    ...
                                    $(".listaIngredientes").each(function() {
                                        var ingrediente = $(this).children(".col-lg-6").children().children(".nuevoNombreIngrediente").children(".idIngredienteEditar").html();
                                        var cantidad = $(this).children(".col-lg-2").children(".nuevaCantidadIngrediente").val();
                                        ...
                                        var id = $(this).children(".col-lg-6").children().children(".nuevoNombreIngrediente").children(".idIngredienteEditar").val();

                                        if(id == null){
                                            id = $(this).children(".col-lg-6").children().children(".ingredienteID").val();
                                        }

                                        if(ingrediente == null){
                                            ingrediente = $(this).children(".col-lg-6").children().children(".selectIngrediente").val();
                                        }
