                                ...
                                <div class="col-sm-12 col-lg-9">
                                    <div class="input-group">
                                                ...
                                                <span class="input-group-prepend d-none d-sm-block">
                                                    <button type="button" class="btn btn-warning btn-xs ml-1 rounded" data-toggle="modal" 
                                                        data-target="#modalAgregarCliente">
                                                        Crear Cliente
                                                    </button>
                                                    <button type="button" class="btn btn-danger btn-xs ml-1 rounded" data-toggle="modal" 
                        ...
                        event.stopPropagation();
                         // Guardo el nombre del menu
                                    ...
                                    $(".listaIngredientes").each(function() {
                                        var ingrediente = $(this).children(".col-lg-6").children().children(".nuevoNombreIngrediente").val();
                                        ...
                                        var id = $(this).children(".col-lg-6").children().children(".ingredienteID").val();
