                ...
                <table class="table table-bordered table-striped dt-responsive tablas tablaClientes" width="100%">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>CUIT</th>
                            <th style="width:10%">Cupos Comedor</th>
                            <th style="width:10%">Cupos DMC</th>
                            <th>Tipo</th>
                        ...
                        <?php
                            ...
                            foreach ($clientes as $key => $value){
                                ...
                                <td>
                                   ...
                                   if($_SESSION["perfil"] == "Administrador"){echo '<button class="btn btn-danger btnEliminarCliente" idCliente="'.$value["id"].'"s><i class="fa fa-times"></i></button>';}
                                echo '</td>
                            </tr>
                                ';
                            }
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="text" id="nuevoOrgano" name="nuevoOrgano"
                                        placeholder="(Opcional) Ingrese Órgano Gubernamental">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="text" id="nuevoCuit" name="nuevoCuit"
                                        placeholder="(Opcional) Ingrese CUIT">
