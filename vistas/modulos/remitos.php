			...
			<div class="card-footer">
					...
					<div class="row">
						...
						<div class="col-3">
							...
							<button type="button" class="btn btn-lg btn-info float-right  btnGuardarRemito" disabled><i class="fa fa-print mr-2"></i>Guardar Remito</button>
						</div>

						<div class="col-3">
							<!-- BOTON PARA IMPRIMIR REMITO -->
							<button type="button" class="btn btn-lg btn-danger float-right  btnImprimirRemito" disabled><i class="fa fa-print mr-2"></i>Imprimir Remito</button>
						</div>
