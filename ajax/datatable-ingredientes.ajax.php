          ...
          $datosJson = '{
            ...
            for($i = 0; $i < count($ingredientes); $i++){
              ...
              if(isset($_GET["perfilOculto"]) && $_GET["perfilOculto"] == "Administrador"){
                ...
                $botones = "<button class='btn btn-warning btnEditarIngrediente' idIngrediente='".$ingredientes[$i]["id"]."' data-toggle='modal' data-target='#modalEditarIngrediente'><i class='fa fa-pencil-alt'></i>";
